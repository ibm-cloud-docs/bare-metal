...
1. Log in to the VPN through either [SSL](/docs/infrastructure/vpn/ssl-vpn-connections.html) or PPTP. Refer to the [VPN topic page](/docs/infrastructure/vpn/index.html).
