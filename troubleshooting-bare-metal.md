...
{: #bm-remote-ssh-logins-disabled-old}
...
1. Add a line in the **Authentication** section of the file that says _PermitRootLogin yes_. This line might exist and be commented out with a "#". In this example, remove the "#".
   ...
   `#MaxSessions 10`
1. Save the updated _/etc/ssh/sshd_config_ file.
...
{: #bm-port-number-configuration-old}
...
{: #bm-firewall-blocking-ssh-traffic-old}
...
{: #bm-troubleshoot-device-not-responding-old}
{: troubleshoot}
{: support}
...
{: #bm-troubleshoot-IPMI-not-accessible-browser-old}
{: troubleshoot}
{: support}
  
* Try to access the IPMI IP through a different browser.
...
{: #bm-troubleshoot-RDP-not-working-old}
{: troubleshoot}
{: support}
...
* [Internet is blocked by a firewall or gateway](#bm-internet-blocked-by-firewall-or-gateway).
