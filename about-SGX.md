...
To provision a bare metal server with Intel SGX, refer to [Provisioning a bare metal server with Intel SGX](/docs/bare-metal//docs/bare-metal/bare-metal-provision-SGX.html)
